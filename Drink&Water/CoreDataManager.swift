...
class CoreDataManager {
    ...
    func saveUser(name: String, lastName: String, gender: Bool, weight: Double, height: Double, birthday: Date) {
    ...
    func deleteUser() {
        ...
        func updateUser(name: String, lastName: String, gender: Bool, weight: Double, height: Double, birthday: Date) {
